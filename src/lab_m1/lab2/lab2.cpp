...
void Lab2::Init()
{
    ...
    // by definition!
    {
        ...
        {
            VertexFormat(glm::vec3(5, 5,  5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(4.5, 4.5,  4), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5.5, 4.5,  4), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(5, 5.5,  4), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-5, -5, -5), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(4.5f, 4.5f, 4), glm::vec3(0.7f));
