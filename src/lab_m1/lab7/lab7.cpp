...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.369f, 0.369f, 0.341f));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3fv(glGetUniformLocation(shader->program, "eye_position"), 1, &eyePosition[0]);
    ...
    glUniform3fv(glGetUniformLocation(shader->program, "object_color"), 1, &color[0]);
